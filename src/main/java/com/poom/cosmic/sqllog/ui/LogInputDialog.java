...
import com.poom.cosmic.sqllog.convert.ClipboardUtils;
import com.poom.cosmic.sqllog.convert.ConvertUtils;
...
public class LogInputDialog extends DialogWrapper {
    ...
    protected LogInputDialog(@Nullable Project project) {
        ...
        setSize(600, 400);
        setResizable(true);
        setTitle("cosmic sql Log Convert");
        initTable();
        init();
    }
...
//        String text = "请复制完整的cosmic sql 日志粘贴到对应的输入框";
...
//    }
    ...
    protected @Nullable JComponent createCenterPanel() {
        ...
        // 创建一个 JPanel，并设置 BoxLayout
//        JPanel panel1 = new JPanel();
//        panel1.setLayout(new BoxLayout(jPanel, BoxLayout.Y_AXIS));



        String text1 = "请复制完整的sql日志粘贴到此处,需包含？";
        JLabel title1 = new JLabel(text1);
        //字体样式
        title1.setFont(new Font("微软雅黑", Font.PLAIN, 14));

        String text2 = "请复制完整的参数到此处,用，分隔";
        JLabel title2 = new JLabel(text2);
        //字体样式
